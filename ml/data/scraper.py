"""
Agmarknet Scraper for Madhya Pradesh Mandi Data.
Run: python scripts/scrape_agmarknet.py
"""
import requests
...
def scrape_mp_prices(crop: str, start_date: str, end_date: str) -> pd.DataFrame:
    """
    Scrape mandi prices for a given crop and date range.
    Returns DataFrame with columns: date, mandi, crop, min_price, max_price, modal_price
    NOTE: Agmarknet may require form submission. Implement POST-based scraping if GET fails.
    """
